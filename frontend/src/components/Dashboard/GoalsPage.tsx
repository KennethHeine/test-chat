...
export function GoalsPage({ token, active }: GoalsPageProps) {
              ...
              <div className="goal-card-body">
                ...
                {goalCounts[goal.id] && (
                  <div className="goal-card-counts">
                    Research: {goalCounts[goal.id].research} ·
                    Milestones: {goalCounts[goal.id].milestones} ·
                    Issues: {goalCounts[goal.id].issues}
                  </div>
                )}
              </div>
            </div>
...
async function fetchGoalCounts(goalId: string): Promise<{
  research: number;
  milestones: number;
  issues: number;
}> {
